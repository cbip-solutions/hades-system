...
-- (tmux_session_state). release track ships priority_overrides because the quota
-- override storage seam needs it now. release track will add tmux_session_state in a
...
--                   (release track) physically removes rows where expires_at < now.
