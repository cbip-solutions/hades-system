...
// Phase G wires /v1/workforce/gate/{pause,resume} endpoints.
//
// Persistence is decoupled via GatePersist (inv-zen-031: gate/* never
...
// handle via the Phase G audit hook.
//
