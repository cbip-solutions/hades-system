...
//
// Worker authors can rely on these guarantees without re-reading
// the implementation.
//
// status: this package is exercised in unit + integration tests
// against tests/testharness/openclaude_fake.go. Real openclaude binary
// integration arrives in realworld tests once Task #55
// lands.
package subprocess
