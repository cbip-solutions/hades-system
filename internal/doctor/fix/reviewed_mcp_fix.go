...
// Package fix — reviewed_mcp_fix.go ships the Fix impl for the
// mcp.reviewed-availability check.
//
// Non-destructive: installs missing reviewed MCPs via package-manager-
