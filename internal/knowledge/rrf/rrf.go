...
//
// Extracted from internal/knowledge/aggregator/rrf.go (Plan 9 D, commit
...
//
// Pre-fix state: Plan 11 Phase C C-5 (aggregator_consumer.go) inlined 135
...
//   - No imports of internal/store (inv-zen-031).
//   - No web calls (inv-zen-129).
//
