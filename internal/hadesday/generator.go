...
// Package hadesday — method-bound façade over the per-call free
// functions.
//
...
//
// The free-function form (`hadesday.GenerateMorningBrief(ctx, deps,
...
// handlers (`internal/daemon/handlers/hadesday.go`) reference
// `hadesday.NewGenerator(...)` returning `*Generator` with methods
