...
// Package hadesday — morning-brief idempotent composer.
//
...
// EventEmitter is the contract hadesday.GenerateMorningBrief +
...
//
// Implementations MUST be safe for concurrent invocation: hadesday Collect
