...
// production code path to a documented invariant. Phase F compliance tests
...
//   - budgetGateRequired            (inv-zen-167)
//   - capaFirewallAugmentDisabled   (inv-zen-170)
//   - aggregatorPrivacyFilterRequired (inv-zen-171)
//
...
// keep the inv-zen-171 anchor reachable.
//
// inv-zen-171: aggregator queries that cross project boundaries MUST be
