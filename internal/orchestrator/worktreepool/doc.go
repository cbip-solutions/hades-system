...
// Package worktreepool — Plan 5 Phase B git-worktree subprocess pool.
//
// Supplies isolated working directories to every Plan 5 subsystem needing
// off-trunk filesystem isolation: HRA voting (Functional Majority Voting
// per Q8 B), ApplyEngine live-correction (Q1 D), and future Plan 6 cross-
...
//   - inv-zen-089: NEVER imports internal/store directly
//   - inv-zen-090: NEVER imports internal/workforce/queue directly
...
//
// Phase D's dispatcher.go is the canonical consumer; HRA voting (Phase I)
// and ApplyEngine (Phase J) call Lease/Release directly.
//
// Privacy contract (Phase A IMP-3 carry-forward): error messages MUST NOT
