...
// C-9 + inv-zen-270). Both identifiers refer to the SAME interface so
// implementors of either satisfy the other via structural typing —
// Phase K's production adapter is constructed against
...
// at runtime). Plan 20's L10 therefore implements its OWN orchestrator
...
//     (the inv-zen-270 AST scan asserts this — the F.7 anti-coupling
...
//     (the seam interface, used downstream by Phase K's production
...
// cross-phase contract change that breaks the test.
