...
// Package openapi — Plan 20 OpenAPI breaking-change detector wrapping
...
// in this file.
//
// AS-BUILT divergence from the Phase G plan: the upstream Go module path
...
// (inv-zen-272) never fires for OpenAPI — only for GraphQL when the
