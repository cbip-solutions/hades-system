...
// Package chi is the HADES design Go go-chi/chi router extractor (Language:
...
//
// Boundary this package and code MUST NOT import internal/store
// ; only internal/caronte/store
// APIEndpoint/APICall types provides.
package chi
