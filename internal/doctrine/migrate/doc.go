...
// the WriteFile separately. Splitting these concerns preserves inv-hades-137:
// "Schema migration write-back is operator-explicit; daemon never auto-rewrites
// disk files".
//
// Per inv-hades-142 (Doctrine schema_version on disk monotonically non-decreasing),
...
//
// Per inv-hades-133 (internal/doctrine/* ⊥ internal/store), this package never
...
// (operator must run `hades doctrine migrate <path>` chained migrations
...
// non-trusted tiers
// MUST enforce inv-hades-135 transverse-rejection separately, either by calling
...
// flow; §4.3 sentinel error inventory; §7.2 inv-hades-137 + inv-hades-142.
package migrate
