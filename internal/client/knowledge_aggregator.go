...
//
// Five typed methods wrapping the five HADES design daemon aggregator routes:
//
...
//
// These are DISTINCT from the HADES design knowledge client methods
// (KnowledgeQuery/KnowledgeReindex/KnowledgeStats in knowledge.go) which
// back /v1/knowledge/{query,reindex,stats}. Both surfaces coexist; HADES design
