...
// Package research implements the Plan 4 zen-mcp-research MCP server.
//
...
// docs/superpowers/specs/2026-04-30-zen-swarm-plan-4-workforce-mcps-design.md
// §1.
//
// Architecture
...
//     gate; pre-check budget (inv-zen-076).
...
//   - ecosystem_docs.go — Plan 14 SHIPPED; backed by
...
//   - inv-zen-086 — stdio canonical: server.go uses only
//     mcp.NewStdioServer; no net.Listen anywhere.
//   - inv-zen-076 — every backend dispatch is wrapped in budget.PreCall;
//     CI grep rule + tests/compliance/inv_zen_076_test.go
//     enforce.
//   - inv-zen-075 — VerifiedCitation type-distinct from RawCitation;
