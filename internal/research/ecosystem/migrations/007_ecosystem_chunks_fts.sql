...
--
-- FTS5 virtual table over the chunks' searchable text columns. the release design
...
--
-- tokenize=unicode61 matches the the release design D aggregator FTS pattern.
--
...
-- pool (mirrors the release design D aggregator/db.go + the release design F cache/db.go pattern).
