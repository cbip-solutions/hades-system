...
--
-- VersionRAG Change nodes (per spec §2.5 Q5=A). Phase E change_extractor
...
-- via FK chain (enforced by trigger; declared at Phase E E-7).
--
...
-- this CHECK is the second; invariants.sql (Phase H) is the third.
