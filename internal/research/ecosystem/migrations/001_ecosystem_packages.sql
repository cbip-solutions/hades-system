...
--
-- One row per (ecosystem, name) tuple. Updated by Phase B ingester's
...
--   UNIQUE = (ecosystem, name). Phase B/C indexer-writer code reads from
--   PackageRef.Ecosystem and writes here directly without translation.
--
--   inv-zen-031 unaffected (this package does not import internal/store);
