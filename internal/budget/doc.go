...
// Package budget implements the daemon-side budget engine for Plan 4
// of zen-swarm.
//
// # Architecture
//
...
//   - Pauser uses persist-first ordering (per Phase E I-6 lesson):
...
//	             pre Phase G; full assertion post Phase G).
//
...
//     pending Plan 3 F-1 merge — documents z-score gap; project-cap
...
//
// Tests assert the (0, nil) contract today. Plan 4 Phase G + a
