...
// Package recognize is the canonical home of HADES design
...
//
// task (internal/onboard/mcp/) imports recognize.Result for
...
// authoritative cross-stage contract — populates fields rather
