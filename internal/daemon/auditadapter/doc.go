...
// Package auditadapter bridges *store.Store to the chain layer
...
// audit_events_raw rows from pre-Phase-9 sessions ( events
...
// the doctor surface (audit.chain-integrity) reports the
