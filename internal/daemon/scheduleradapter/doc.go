...
// daemon.db. Satisfies inv-zen-031: internal/scheduler/* never imports
...
// store.ScheduleHistoryRow value types. Plan 7 Phase D Task D-2 lands
...
//
// inv-zen-122 boundary: the import list of this package is the single
// legitimate co-location of internal/scheduler (when D-2 lands it) and
// internal/store anywhere in the codebase. The Phase K compliance test
// inv_zen_122_inv_zen_031_plan7_packages_test.go extends to enforce
// this on Plan-7 packages.
