...
// NewZenSwarmTransport constructs a ZenSwarmTransport bound to the given
...
func NewZenSwarmTransport(dispatcher Dispatcher, anchor AuditAnchor) *ZenSwarmTransport {
	if dispatcher == nil {
		panic("transport.NewZenSwarmTransport: dispatcher is required")
	}
	return &ZenSwarmTransport{
		dispatcher: dispatcher,
		anchor:     anchor,
	}
}

func (t *ZenSwarmTransport) Forward(ctx context.Context, req providers.TierRequest) (*providers.TierResponse, error) {
	resp, err := t.dispatcher.Forward(ctx, req)
	if err != nil {
		return nil, fmt.Errorf("zenswarm-transport: %w", err)
	}
	return resp, nil
}

func (t *ZenSwarmTransport) Probe(_ context.Context) error { return nil }

func (t *ZenSwarmTransport) Close() error { return nil }
...
func (t *ZenSwarmTransport) Tier() providers.Tier { return providers.TierInHouse }
