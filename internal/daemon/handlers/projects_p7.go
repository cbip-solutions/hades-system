...
//
// Three POST routes for the HADES design project lifecycle surface:
//
...
//
// These operate on the projects_alias / path_history substrate (HADES design
...
// projects.go in the same package, which carries HADES design stubs for the
