...
// Package handlers — zenday.go (Plan 7 Phase F Task F-10).
//
// Three routes for the Plan 7 zen day operator surface:
//
...
//
// These dispatch to a *zenday.Generator wired at daemon boot (Phase I
...
// deps each call (mirrors the Plan 7 Phase E inbox-store gate pattern).
//
...
//
// inv-zen-031 boundary: this handler imports internal/zenday value
