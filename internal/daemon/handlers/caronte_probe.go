...
// `zen doctor caronte` CLI section (Plan 19 Phase L; extended Phase F
//
...
// "fail" for every probe today. Phase F closes the gap by adding the
...
//                             constructed (Phase F; inv-zen-278). Reads
...
// non-GET.
//
// Phase E (CLI router migration) may later replace the route with a
