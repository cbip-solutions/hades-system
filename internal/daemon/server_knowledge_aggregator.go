...
// Package daemon — server_knowledge_aggregator.go.
//
...
//
// carry-forward: embed_worker registration (SetRebuildChannel) is
...
// RegisterKnowledgeAggregator mounts the five HADES design D-12 aggregator routes:
//
