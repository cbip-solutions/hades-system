...
// Package tessera implements the Plan 9 transparency-log audit substrate.
//
// Per spec §0 + §1 Q1 D: Plan 9 ships RFC 9162 tile-based transparency
...
// doctrine-tunable. Phase A wires the configuration knob; Phase J
...
//
//   - inv-zen-031 — this package MUST NOT import internal/store.
//     Bridge Phase B's internal/daemon/auditadapter/ + the chain layer
//     in internal/audit/chain/.
//   - inv-zen-144 — per-project Tessera tile-log isolation: cross-project
...
//     internal/lint/noCrossProjectAtTessera (Phase J).
//   - inv-zen-145 — daemon witness signature mandatory en daemon_global_
...
//     Phase B's responsibility; this package provides the Tessera
...
//     [audit.witness] doctrine knob (Phase J binds).
package tessera
