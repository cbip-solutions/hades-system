...
var (
	...
	// caller passes an empty project_id. Per inv-zen-144, every
	...
	// to the daemon_global_checkpoint_log. Per inv-zen-145, every
	...
	// Per inv-zen-144 isolation MUST be enforced at the API surface.
