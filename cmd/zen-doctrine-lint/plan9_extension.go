...
// plan9_extension.go — Task J-10 analyzer registration.
//
// Registers 3 custom go vet analyzers into the zen-doctrine-lint
// plugin binary:
//
...
// without explicit project-ACL check.
//
// # Registration mechanism
//
// package-level pluginAnalyzers slice). therefore cannot use
...
//
// 2. Future wiring:.custom-gcl.yml + BuildAnalyzers() update
// will merge RegisteredAnalyzers() into the plugin's returned set.
// That wiring is the operator-driven task; J-10 ships the
// registration surface and validates the analyzers are ready.
//
// # wiring note
//
// To activate analyzers in the golangci-lint plugin bundle,
