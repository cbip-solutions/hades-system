...
// plan19_extension.go — Plan 19 (Caronte) Phase I analyzer registration.
//
// Registers Plan 19's go vet analyzer surface into the zen-doctrine-lint
...
//     trailer (inv-zen-238; spec §10). Default OFF = no-op.
//
...
// additive — Plan 9's RegisteredAnalyzers + Plan 14's Plan14RegisteredAnalyzers
...
//
// To activate the Plan 19 analyzer alongside Plan 8 + 9 + 14 in the golangci-
...
//   - inv-zen-238 (Lore enforcement when enabled)
//   - Plan 9 J-10 plan9_extension.go + Plan 14 H-1 plan14_extension.go precedent
package main
