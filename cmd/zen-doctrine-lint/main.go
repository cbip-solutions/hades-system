...
// for zen-swarm Plan 8 doctrine static analysis (per spec §1 Q4 B).
//
...
//     inv-zen-031 per Q16 D and generalizes to inv-zen-133
...
//
//	# .custom-gcl.yml at repo root (Phase M creates):
//	# version: v1.61.0
//	# plugins:
...
//
// Or invoke standalone for ad-hoc dogfood (Phase L verification):
//
...
//   - Spec §1 Q16 D: inv-zen-031 → analysistest single source of truth
//   - Spec §2.1: lint package perimeter
//   - Spec §2.2 inv-zen-133: internal/doctrine/* ⊥ internal/store
