...
// Command zen-knowledge-watcher runs the knowledge file watcher as a
...
func parseConfig(fs *flag.FlagSet, args []string) (config, error) {
	...
	idxPath := fs.String("index", "", "knowledge index DB path (default: ~/.cache/zen-swarm/knowledge-index/index.db)")
...
func main() {
	logger := log.New(os.Stderr, "zen-knowledge-watcher: ", log.LstdFlags)
