...
// cmd/hades-ctld/mcpgateway_wiring.go
//
	...
	return mcpgateway.RBACConfig{
		DoctrineDisabled: map[mcpgateway.Doctrine][]string{
			mcpgateway.DoctrineCapaFirewall: {
				...
				"mcp_hades-system_caronte_get_contract",
				"mcp_hades-system_caronte_get_consumers",
				"mcp_hades-system_caronte_get_breaking_changes",
				"mcp_hades-system_caronte_trace_api_call",
				"mcp_hades-system_caronte_get_workspace",
				"mcp_hades-system_caronte_federation_health",
				"mcp_hades-system_caronte_contract_diff",
				"mcp_hades-system_caronte_get_why_breaking_change",
