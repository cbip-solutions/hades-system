...
# Canonical daemon path for the audit-emit endpoint. Source-of-truth:
# ``internal/daemon/server.go:737`` ``mux.Handle("POST /v1/audit/emit",
# rl("audit_emit", handlers.AuditEmit(s)))``.
