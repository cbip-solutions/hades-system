...
description: |
  ...
  doctrine-change proposals (HADES design + HADES design). All decisions audit-logged
  via HADES design Tessera chain. Use when operator invokes /hades:amendment-* commands.
license: Proprietary
