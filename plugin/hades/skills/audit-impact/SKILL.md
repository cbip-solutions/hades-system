...
name: audit-impact
description: |
  HADES audit event KG context: resolve a HADES design Tessera-anchored audit
...
This skill resolves a HADES design Tessera-anchored audit event and shows its full
