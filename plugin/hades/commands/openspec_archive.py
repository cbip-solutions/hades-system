...
## 6. NEVER add Claude/Anthropic/AI attribution (inv-zen-004)

Plan 11 substrate hook (`hooks/llm_handlers.py` pre_llm_call callback) regex-rejects commit messages containing:
...
- inv-zen-004 NO Claude attribution
- Plan 6 MergeEngine (winner selection per spec §4.4)
