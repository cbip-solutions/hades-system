...
## 6. NEVER add Claude/Anthropic/AI attribution

 substrate hook (`hooks/llm_handlers.py` pre_llm_call callback) regex-rejects commit messages containing:
...
-  MergeEngine (winner selection per spec §4.4)
