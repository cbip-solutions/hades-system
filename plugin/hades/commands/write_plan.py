...
- Master file: `docs/superpowers/plans/YYYY-MM-DD-plan-N-<topic>-master.md` (~150-200 lines)
...
### Stage 2 — Code-reviewer subagent dispatch (MANDATORY)
- Dispatch `superpowers:code-reviewer` foreground
- Cross-phase signature/field-set drift
- Skipping Stage 2 = compile errors guaranteed during execution
