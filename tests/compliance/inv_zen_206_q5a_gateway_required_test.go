...
//
// inv-zen-206 — Plan 11 Q5=A: gateway boot is unconditional + the code-graph
...
//
// As of Plan 19 Phase J the backend is the in-process Caronte engine
...
// no env-var bypass — only the backend changed. inv-zen-239 owns the
...
//   unconditional. Pre-fix Phase A had this wrapped in
...
//
// As of Plan 19 Phase J the backend is Caronte (buildCaronteEngine /
// caronte.NewEngine). inv-zen-239 owns the AST-level bootstrap assertions;
