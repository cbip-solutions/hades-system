...
//
// Compliance gate for inv-zen-146: Promote and Unpromote are OPERATOR-GATED
...
//
// inv-zen-146: Promote/Unpromote reason required.
//
...
//	provide complete inv-zen-146 coverage (Step 2 + Step 1
